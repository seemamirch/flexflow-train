...
void require_invocation_is_ready_for_copy_insertion(DynamicNodeInvocation const &);
void require_graph_is_ready_for_copy_insertion(DynamicOpenDataflowGraph const &);
...
std::set<DynamicValueCopyInfo> infer_all_copies_in_graph(DynamicOpenDataflowGraph const &);
