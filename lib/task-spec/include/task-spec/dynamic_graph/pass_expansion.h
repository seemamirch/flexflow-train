...
void require_invocation_is_ready_for_pass_expansion(DynamicNodeInvocation const &);

void require_graph_is_fully_pass_expanded(DynamicOpenDataflowGraph const &);
void require_graph_is_ready_for_pass_expansion(DynamicOpenDataflowGraph const &);
